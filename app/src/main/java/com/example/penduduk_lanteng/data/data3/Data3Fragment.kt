...
class Data3Fragment : Fragment(), PendudukAdapter.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        binding.buttonSearch.setOnClickListener {
            ...
            if (nik.isNotEmpty()) {
                pendudukViewModel.searchPendudukByNIKAndRT(nik, "3").observe(viewLifecycleOwner) { searchResults ->
    ...
    override fun onItemClick(penduduk: Penduduk) {
        ...
        findNavController().navigate(R.id.action_data3Fragment_to_detail1Fragment2, bundle)
    }
